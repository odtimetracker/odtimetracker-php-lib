    ...
    final public static function getDataActivities()
    {
        return array(
            array(
                ...
                'Tags' => 'tag1,tag2,tag3',
                'Started' => new \DateTime('2011-10-05 10:00:00.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-05 13:00:00.0000+1:00')
            ),
            array(
                'ActivityId' => 2,
                'ProjectId' => 1,
                ...
                'Tags' => 'tag2,tag3',
                'Started' => new \DateTime('2011-10-05 14:10:00.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-05 21:15:30.0000+1:00')
            ),
            array(
                'ActivityId' => 3,
                'ProjectId' => 1,
                ...
                'Tags' => 'tag3,tag5',
                'Started' => new \DateTime('2011-10-06 07:15:00.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-06 19:45:00.0000+1:00')
            ),
            array(
                'ActivityId' => 4,
                'ProjectId' => 1,
                ...
                'Tags' => null,
                'Started' => new \DateTime('2011-10-07 09:15:00.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-07 09:19:00.0000+1:00')
            ),
            array(
                'ActivityId' => 5,
                'ProjectId' => 2,
                ...
                'Description' => null,
                'Tags' => '',
                'Started' => new \DateTime('2011-10-07 10:01:10.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-07 10:31:06.0000+1:00')
            ),
            array(
                'ActivityId' => 6,
                'ProjectId' => 3,
                ...
                'Tags' => 'tag1,tag4',
                'Started' => new \DateTime('2011-10-07 12:01:10.0000+1:00'),
                'Stopped' => new \DateTime('2011-10-07 14:11:24.0000+1:00')
            ),
            array(
                'ActivityId' => 7,
                'ProjectId' => 4,
                ...
                'Tags' => 'tag4',
                'Started' => new \DateTime('2011-10-08 09:04:00.0000+1:00'),
                'Stopped' => null
            )
        );
    ...
    final public static function getDataProjects()
    {
        return array(
            array(
                ...
                'Created' => new \DateTime('2011-10-05 09:00:00.0000+1:00')
            ),
            array(
                'ProjectId' => 2,
                'Name' => 'Project #2',
                'Description' => 'The second test project.',
                'Created' => new \DateTime('2011-10-05 09:21:00.0000+1:00')
            ),
            array(
                'ProjectId' => 3,
                'Name' => 'Project #3',
                'Description' => 'The third test project.',
                'Created' => new \DateTime('2011-10-05 09:35:00.0000+1:00')
            ),
            array(
                'ProjectId' => 4,
                'Name' => 'Project #4',
                'Description' => 'The fourth test project.',
                'Created' => new \DateTime('2011-10-05 10:40:00.0000+1:00')
            ),
            array(
                'ProjectId' => 5,
                'Name' => 'Project #5',
            ...
            array(
                ...
                'Created' => new \DateTime('2011-10-10 13:00:00.0000+1:00')
            ),
            array(
                'ProjectId' => 7,
                'Name' => 'Project #7',
                'Description' => 'The seventh test project.',
                'Created' => new \DateTime('2011-10-10 13:30:00.0000+1:00')
            )
        );
    } // end getDataProjects()
